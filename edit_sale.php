    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    $session->msg('s',"Venta Actualizado.");
                    redirect('edit_sale.php?id='.$sale['id'], false);
                  } else {
                    $session->msg('d',' No se pudo actualizar la venta!');
  ...
  <div class="panel">
    <div class="panel-heading clearfix">
     ...
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">Regresar a Ventas</a>
     </div>
    </div>
